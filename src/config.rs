...
/// Current: 0.075 = 7.5% = 1 in 13 messages on average
/// For very active chats (500 msg/hr): ~40 proactive/hr
/// For moderate chats (100 msg/hr): ~8 proactive/hr
pub const ACTIVE_MESSAGE_CHANCE: f64 = 0.075; // 7.5% - less annoying
...
pub const MAX_CONVERSATION_HISTORY: usize = 80;

/// Maximum recent messages to track per chat
pub const MAX_RECENT_MESSAGES: usize = 120;
...
pub const MIN_TIME_BETWEEN_PROACTIVE: u64 = 7200; // 2 hours (2 * 60 * 60)
pub const MAX_TIME_BETWEEN_PROACTIVE: u64 = 21600; // 6 hours (6 * 60 * 60)
...
/// Cooldown (seconds) to pause proactive messages if Telegram rejects sending
pub const PROACTIVE_BLOCK_COOLDOWN_SECS: u64 = 3600; // 1 hour
...
pub const GROK_MODEL_PROACTIVE: &str = "grok-4-fast-reasoning";
pub const GROK_TEMPERATURE: f32 = 0.8;
pub const GROK_TEMPERATURE_PROACTIVE: f32 = 1.0;
pub const GROK_MAX_TOKENS: u32 = 2048;
pub const GROK_ENABLE_SEARCH_DEFAULT: bool = true;
pub const GROK_ENABLE_MULTIMODAL_DEFAULT: bool = true;
